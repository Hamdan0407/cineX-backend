...
public class PaginationServiceTest {
    ...
    void testMoviePaginationAndSorting() {
        ...
        for (int i = 1; i <= 3; i++) {
            MovieRequest m = new MovieRequest();
        ...
        Page<MovieResponse> page0 = movieService.getMoviesPaginated(0, 2, "id", "desc");
        ...
        Page<MovieResponse> page1 = movieService.getMoviesPaginated(1, 2, "id", "desc");
        assertNotNull(page1);
    ...
    void testTheatrePagination() {
        for (int i = 1; i <= 3; i++) {
            TheatreRequest t = new TheatreRequest();
        ...
        Page<TheatreResponse> page = theatreService.getTheatresPaginated(0, 5, "name", "asc");
        assertNotNull(page);
    ...
    void testShowPagination() {
        Page<ShowResponse> page = showService.getShowsPaginated(0, 10, "id", "asc");
        assertNotNull(page);
